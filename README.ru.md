...
[Начать](#быстрый-старт) • [Документация](https://yeachan-heo.github.io/oh-my-openagent-website) • [Руководство по миграции](docs/MIGRATION.md)
...
> **Примечание: Название пакета** — Проект использует бренд **oh-my-openagent** (репозиторий, плагин, команды), но npm-пакет публикуется как [`oh-my-openagent`](https://www.npmjs.com/package/oh-my-openagent). Если вы устанавливаете CLI-инструменты через npm/bun, используйте `npm install -g oh-my-openagent`.
...
Множество стратегий для разных сценариев — от оркестрации через Team до рефакторинга с экономией токенов. [Подробнее →](https://yeachan-heo.github.io/oh-my-openagent-website/docs.html#execution-modes)
...
| -------------- | ----------------------------------------------- | --------------------------------------------------------------- |
| `team`         | Каноническая Team-оркестрация                   | `/oh-my-openagent:team 3:executor "fix all TypeScript errors"` |
...
- **[Веб-сайт](https://yeachan-heo.github.io/oh-my-openagent-website)** — Интерактивные руководства и примеры
