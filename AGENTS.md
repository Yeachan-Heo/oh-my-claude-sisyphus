...
| ---------------------- | -------------------------------------------------------------------------- |
| `agents/*.md`          | `src/agents-v4/roles.ts`, `src/agents-v4/registry.ts`, `docs/REFERENCE.md` |
...
| `agents/*.md` files                    | `src/agents-v4/` (implementation details) |
...
| `src/agents-v4/*.ts`                   | `src/agents-v4/` directory                |
