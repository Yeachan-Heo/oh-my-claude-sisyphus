...
| `refactor`        | Intelligent LSP+AST refactoring workflow      | `/oh-my-claudecode:refactor`        |
...
Oh-my-claudecode includes 32 lifecycle hooks that enhance Claude Code's behavior.
...
| `output-truncator`          | Dynamic output truncation based on context usage |
