...
[Inizia](#avvio-rapido) • [Documentazione](https://yeachan-heo.github.io/oh-my-openagent-website) • [Guida alla migrazione](docs/MIGRATION.md)
...
> **Nota: Nome del pacchetto** — Il progetto utilizza il brand **oh-my-openagent** (repo, plugin, comandi), ma il pacchetto npm è pubblicato come [`oh-my-openagent`](https://www.npmjs.com/package/oh-my-openagent). Se installi gli strumenti CLI tramite npm/bun, usa `npm install -g oh-my-openagent`.
...
Strategie multiple per diversi casi d'uso — dall'orchestrazione basata su Team al refactoring efficiente in termini di token. [Scopri di più →](https://yeachan-heo.github.io/oh-my-openagent-website/docs.html#execution-modes)
...
| ------------- | ----------------------------------------- | --------------------------------------------------------------- |
| `team`        | Orchestrazione Team canonica              | `/oh-my-openagent:team 3:executor "fix all TypeScript errors"` |
...
- **[Sito web](https://yeachan-heo.github.io/oh-my-openagent-website)** — Guide interattive ed esempi
