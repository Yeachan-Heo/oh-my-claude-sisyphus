...
38 skill definitions for workflow automation and specialized behaviors.
...
| `refactor/SKILL.md`        | refactor        | LSP+AST intelligent refactoring  |
...
| Quality     | code-review, security-review, tdd, build-fix, refactor            | "review", "security", "tdd", "refactor"     |
