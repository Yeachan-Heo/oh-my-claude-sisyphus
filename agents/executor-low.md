...
**Note to Orchestrators**: When delegating to this agent, use the Worker Preamble Protocol (`wrapWithPreamble()` from `src/shared/prompts/preamble.ts`) to ensure this agent executes tasks directly without spawning sub-agents.
</Tier_Identity>
